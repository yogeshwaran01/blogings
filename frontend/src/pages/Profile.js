...
const Profile = () => {
    ...
    const fetchContents = async () => {
        let url = `http://localhost:5001/market-9c3c5/us-central1/api/user/${userName}`
        ...
        <section className="bg-gradient-to-br from-green-500 to-yellow-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    <div className="m-1 mr-2 h-12 relative flex justify-center items-center rounded-full">
